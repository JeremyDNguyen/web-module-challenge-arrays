...
function copy(array){ // Array is a generic name for the array "originalFlavors"
    return array;
}
...
getFlavorByIndex(originalFlavors, 25);
...
function removeFlavorByName(array, string){
    array.splice(array,indexOf(string),4)
    return array;
}
removeFlavorByName(originalFlavors, "Cherry Macaron");
...
filterByWord(originalFlavors, "Choclate");
